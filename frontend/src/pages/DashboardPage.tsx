  ...
  return (
    <div className="min-h-screen bg-bg">
      <div className="mx-auto max-w-xl px-4 py-16">
        ...
        <button
          onClick={logout}
          className="rounded-xl border border-border px-4 py-2 text-sm font-medium text-ink-soft transition-colors hover:border-sage hover:text-sage cursor-pointer"
        >
          Wyloguj się
        </button>
